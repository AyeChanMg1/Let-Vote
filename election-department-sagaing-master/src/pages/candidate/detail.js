...
const CandidateDetail = (props) => {
    ...
    return <div className="content">
        <p className='page-nav'><Link to='/' style={{ color: 'black' }}>မူလစာမျက်နှာ</Link> <RightOutlined /> <Link to='/candidate' style={{ color: 'black' }}>ကိုယ်စားလှယ်လောင်းများ</Link> <RightOutlined /> <a style={{color:'#aaa', textDecoration:'none'}}>ကိုယ်စားလှယ်လောင်း Detail</a></p>
